...
const categories: Category[] = [
  ...
  { id: 'cat-info', name: 'Informática', parentId: null },
  { id: 'cat-info-notebooks', name: 'Notebooks', parentId: 'cat-info' },
  { id: 'cat-info-memorias', name: 'Memórias', parentId: 'cat-info' },
  { id: 'cat-info-ssd', name: 'SSD', parentId: 'cat-info' },
...
const products: Product[] = [
  ...
  },
  {
    ...
    description: 'Memória Kingston Fury Beast 16GB 3200MHz para desktops.',
    price: 289.9,
    stock: 40,
    categoryId: 'cat-info-memorias',
    brand: 'Kingston',
    sellerId,
    sellerName: 'Maria Vendedora',
    images: ['https://picsum.photos/seed/ram/600/600'],
    weight: 0.05,
    dimensions: { width: 15, height: 2, length: 5 },
  },
  {
    id: 'prod-8',
    title: 'SSD NVMe 1TB Samsung',
    description: 'SSD Samsung 990 PRO NVMe M.2 com leitura de até 7450 MB/s.',
    price: 649.9,
    stock: 25,
    categoryId: 'cat-info-ssd',
    brand: 'Samsung',
    sellerId,
    sellerName: 'Maria Vendedora',
    images: ['https://picsum.photos/seed/ssd/600/600'],
    weight: 0.08,
    dimensions: { width: 8, height: 1, length: 2 },
  },
  {
    id: 'prod-9',
    title: 'Notebook Lenovo IdeaPad',
    description: 'Notebook Lenovo IdeaPad 15" com Ryzen 5 e 8GB RAM.',
    price: 3199.0,
    stock: 10,
    categoryId: 'cat-info-notebooks',
    brand: 'Lenovo',
    sellerId,
    sellerName: 'Maria Vendedora',
    images: ['https://picsum.photos/seed/lenovo/600/600'],
    weight: 1.8,
    dimensions: { width: 36, height: 2, length: 25 },
  },
]
